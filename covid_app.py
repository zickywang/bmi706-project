...
start_date, end_date = st.slider("Select a range of date for the first two visualizations", min_value=datetime.date(2020, 4, 1), max_value=max(df['date'].dt.date), value=[datetime.date(2020, 6, 1), datetime.date(2022, 1, 1)], format="YYYY-MMM-DD")
